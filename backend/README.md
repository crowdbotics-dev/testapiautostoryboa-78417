...
## Project Structure
    ...
    ├── testapiautostoryboa_78417  # Django project configurations
...
1. Clone this repo and `cd testapiautostoryboa_78417`
...
2. Clone this repo and `cd testapiautostoryboa_78417`
